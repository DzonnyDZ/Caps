...
Public Class StaticExExtension
    ...
    Public Overrides Function ProvideValue(ByVal serviceProvider As System.IServiceProvider) As Object
        If Member Is Nothing Then Throw New InvalidOperationException(My.Resources.ex_IsNull.f("Member"))
        ...
        If Resolver Is Nothing Then Throw New ArgumentException(My.Resources.ex_ServiceProviderDoesntProvide.f(GetType(IXamlTypeResolver).Name))
        Dim parts = Member.Split(".")
        If parts Is Nothing OrElse parts.Length = 0 Then Throw New InvalidOperationException(My.Resources.ex_CannotBeAnEmptyString.f("Member"))
        Dim type = Resolver.Resolve(parts(0))
        If parts.Count = 1 Then Throw New InvalidOperationException(My.Resources.ex_DoesNotContainMemberNamePart.f("Member"))
        ...
        For i As Integer = 2 To parts.Length - 1
            If CurrVal Is Nothing Then Throw New NullReferenceException(My.Resources.ex_MemberHasValueNull.f(parts(i - 1)))
