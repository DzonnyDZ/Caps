...
Partial Public Class winNewSign
    ...
    Private Sub btnOK_Click(ByVal sender As System.Object, ByVal e As System.Windows.RoutedEventArgs) Handles btnOK.Click
        If Not IO.File.Exists(txtImagePath.Text) Then
            Select Case mBox.ModalF_PTBIa(My.Resources.msg_FileNotExists_ContinueWOImage, My.Resources.txt_SignImage, WindowsT.IndependentT.MessageBox.MessageBoxButton.Buttons.Yes Or WindowsT.IndependentT.MessageBox.MessageBoxButton.Buttons.No, WindowsT.IndependentT.MessageBox.MessageBoxIcons.Question, txtImagePath.Text)
                Case Forms.DialogResult.Yes
                Case Else : Exit Sub
            End Select
        ElseIf IO.Path.GetExtension(txtImagePath.Text).ToLower <> ".png" Then
            mBox.Modal_PTI(My.Resources.msg_OnlyPNG, My.Resources.txt_SignImage, WindowsT.IndependentT.MessageBox.MessageBoxIcons.Exclamation)
            Exit Sub
        End If
        Try
            _NewObject = New CapSign() With {.Name = txtName.Text, .Description = txtDescription.Text}
            Context.CapSigns.InsertOnSubmit(_NewObject)
        ...
        If IO.File.Exists(txtImagePath.Text) Then
            If Not IO.Directory.Exists(IO.Path.Combine(My.Settings.ImageRoot, "CapSign")) Then
                ...
                Catch ex As Exception
                    mBox.Error_XPTIBWO(ex, My.Resources.err_CreatingDirectorySign, My.Resources.txt_FileSystemError, mBox.MessageBoxIcons.Exclamation)
            ...
            Catch ex As Exception
                mBox.Error_XPTIBWO(ex, My.Resources.msg_CopyCapSignImageError, My.Resources.txt_FileSystemError, WindowsT.IndependentT.MessageBox.MessageBoxIcons.Exclamation)
            End Try
        End If
        Me.DialogResult = True
        Me.Close()
