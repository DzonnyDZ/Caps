...
Module Main
    ...
    Public ReadOnly DatabaseVersion As New Version(0, 0, 1, 0)
...
Public Structure DatabaseVerificationResult
    ...
    Public ReadOnly Property IsOK() As Boolean
        Get
            Return DatabaseGuid IsNot Nothing AndAlso DatabaseVersion IsNot Nothing AndAlso DatabaseGuid = Main.DatabaseGuid _
                   AndAlso DatabaseVersion IsNot Nothing AndAlso _
                    (DatabaseVersion.Major = Main.DatabaseVersion.Major AndAlso DatabaseVersion.Minor = Main.DatabaseVersion.Minor AndAlso DatabaseVersion.Build = Main.DatabaseVersion.Build)
        End Get
    End Property
